...
H1_D1 = B1d(:, 1);
H1_B1 = B1d;
H1_N1 = H1_N;%[0 0; 0 -0.9375; -0.9375 0];%H1_N;
H1_T1 = [H1_N1 H1_D1];
H1_INV_T1 = inv(H1_T1);
...
H1_D2 = B2d(:, 1);
H1_B2 = B2d;
H1_N2 = H1_N;%[0 0; 0 -1.125; -1.125 0];%H1_N;
H1_T2 = [H1_N2 H1_D2];
H1_INV_T2 = inv(H1_T2);
...
H1_D3 = B3d(:, 1);
H1_B3 = B3d;
H1_N3 = H1_N;%[0 0; 0 -1.25; -1.25 0];%H1_N;
H1_T3 = [H1_N3 H1_D3];
H1_INV_T3 = inv(H1_T3);
...
H1_Q1 = H1_Q;%[0 0; -0.9375 0; 0 -0.9375];%H1_Q;
H1_U1 = [C*H1_D1 H1_Q1];
H1_inv_U1 = inv(H1_U1);
H1_U1_1 = H1_inv_U1(1, :);
...
H1_Q2 = H1_Q;%[0 0; -1.125 0; 0 -1.125];%H1_Q;
H1_U2 = [C*H1_D2 H1_Q2];
H1_inv_U2 = inv(H1_U2);
H1_U2_1 = H1_inv_U2(1, :);
...
H1_Q3 = H1_Q;%[0 0; -1.25 0; 0 -1.25];%H1_Q;
H1_U3 = [C*H1_D3 H1_Q3];
H1_inv_U3 = inv(H1_U3);
H1_U3_1 = H1_inv_U3(1, :);
